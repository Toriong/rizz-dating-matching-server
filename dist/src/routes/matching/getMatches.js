    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (validMatchesToSendToClient.length < 5) {
            ...
            if (!currentUser) {
                ...
                getValidMatchesResult = { hasReachedPaginationEnd: true, validMatches: currentValidUserMatches, updatedSkipDocsNum: _userQueryOpts.skipDocsNum, canStillQueryCurrentPageForUsers: false, didErrorOccur: true };
                break;
            }
